  ...
  const jobs = [
    {
      ...
      bullets: [
        'Designed weekly social media content calendars and optimized strategy using analytics',
        'Sourced and secured local influencer partnerships; coordinated sponsorships and events',
        'Developed consumer email marketing campaigns with segmented subscriber lists',
    ...
    },
    {
      ...
      meta: 'Jersey City, NJ\nMay – Aug 2024',
      num: '02',
      role: 'Digital Production Marketing Intern',
      bullets: [
        'Produced written, video, and visual content for multi-channel marketing campaigns',
        'Increased social media engagement through consistent content publishing',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Researched, wrote, and edited scripts in AP style for journalistic quality',
        'Delivered live and recorded news broadcasts with on-camera presence',
      ],
      delay: '0.25s',
    },
  ];
...
function EducationSection() {
  const certs = [
    { name: 'Google Analytics', date: 'May 2025' },
